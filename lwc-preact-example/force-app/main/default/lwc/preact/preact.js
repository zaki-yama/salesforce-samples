...
function a(n, l, u) {
  ...
  if (arguments.length > 3)
    for (u = [u], r = 3; r < arguments.length; r++) u.push(o[r]);
  if (
    (null != u && (f.children = u),
...
function T(l, u, i, t, r, o, f, e, s) {
  ...
  null != i.__h &&
    ((s = i.__h), (e = u.__e = i.__e), (u.__h = null), (o = [e])),
    (a = n.__b) && a(u);
  ...
  try {
    n: if ("function" == typeof P) {
      ...
      (v.context = x),
        ...
        b(l, Array.isArray(A) ? A : [A], u, i, t, r, o, f, e, s),
        (v.base = u.__e),
        (u.__h = null),
        v.__h.length && f.push(v),
        m && (v.__E = v.__ = null),
      ...
      null == o && u.__v === i.__v
        ...
        : (u.__e = z(i.__e, u, i, t, r, o, f, s));

    (a = n.diffed) && a(u);
  } catch (l) {
    (u.__v = null),
      (s || null != o) &&
        ((u.__e = e), (u.__h = !!s), (o[o.indexOf(e)] = null)),
      n.__e(l, u, i);
  }
}
...
function z(n, l, u, i, t, r, e, c) {
  ...
  if (null === _) p === d || (c && n.data === d) || (n.data = d);
    ...
    if (
      ((r = r && f.slice.call(n.childNodes)),
      (v = (p = u.props || o).dangerouslySetInnerHTML),
    ...
    if ((A(n, d, p, t, c), h)) l.__k = [];
      ...
      for (k = r.length; k--; ) null != r[k] && s(r[k]);
    c ||
      ("value" in d &&
        void 0 !== (k = d.value) &&
...
function N(l, u, i) {
  var t, r, e;
  n.__ && n.__(l, u),
    (r = (t = "function" == typeof i) ? null : (i && i.__k) || u.__k),
    (e = []),
    T(
      u,
...
function createApp(el, data) {
  const app = a("div", null, "hello, world!");
  N(app, el);
  return app;
}
